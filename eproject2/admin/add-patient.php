...
$sql="INSERT INTO `patient`(`p_id`, `p_email`, `p_name`, `p_password`, `p_address`, `P_nic`, `p_dob`, `p_contect`) 
VALUES (NULL,'$email','$name','$pass','$addres','$nic','$dob','$cont')";

// $sql ="INSERT INTO `patient`(`p_id`, `p_email`, `p_name`, `p_password`, `p_address`, `P_nic`, `p_dob`, `p_contect`) 
//  VALUES (NULL,'$email','$name','$pass','$addres','$nic','$dob','$cont')";

// $sql ="INSERT INTO `patient`(`pid`, `pname`, `pemail`, `ppassword`, `paddress`, `pdob`, `pgender`, `pnic`, `pcontect`) 
// VALUES (NULL,'$name','$email','$pass','$addres','$dob','$gender','$nic','$cont')";
                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form action="" method="post">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Contect</label>
                                            ...
                                            <input type="tel" name="cont" class="form-control">
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" name="submit"  class="btn btn-primary submit-btn" id="u1">Create patient</button>
                            </div>
                        </form>
                    </div>
                </div>
