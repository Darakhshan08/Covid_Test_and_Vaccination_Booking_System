            ...
            <div class="page-wrapper">
                ...
                <div class="ch" id="h3">
                    <h2 >Status</h2>
                            ...
                            <input type="search" name="search" class="input-text header-searchbar"  placeholder="  Search hospital name or Email" list="patient">&nbsp;&nbsp;
                         <a href="hospitals.php"> <input type="Submit" value="Search" class="login-btn btn-primary btn" style="padding-left: 25px;padding-right: 25px;padding-top: 10px;padding-bottom: 10px;"></a>  </div>
                        ...
                        <div class="col-12 col-md-12 col-lg-12 col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h3 class="card-title d-inline-block">Upcoming Appointments until Next
                                    <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>

                                    </h3> <a href="appointments.php" class="btn btn-primary float-right">View all</a>
                                </div>
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody> <th style="min-width:10;">Appointment Number</th>
                                            <th>Patient Name</th>
...
&nbsp;
                    ...
                    <div class="row" id="t1" >
                        <div class="col-12 col-md-6 col-lg-8 col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title d-inline-block">Upcoming Session until Next 
                                    <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
