                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="<?php echo $row['p_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" type="email" name="email" value="<?php echo $row['p_email']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Password<span class="text-danger">*</span></label>
                                        <input class="form-control" type="password" name="pass" value="<?php echo $row['p_password']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>NIC</label>
                                        <input class="form-control" type="text" name="nic" value="<?php echo $row['P_nic']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                     ...
                                     <div class="">
                                        <input class="form-control" type="date" name="dob" value="<?php echo $row['p_dob']; ?> ">
                                     </div>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Contect</label>
                                            ...
                                            <input type="tel" name="cont" value="<?php echo $row['p_contect']; ?>" class="form-control">
