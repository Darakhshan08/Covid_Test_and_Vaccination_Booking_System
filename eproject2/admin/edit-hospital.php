...
$sql="SELECT * from `hospital` where h_id=$id";
...
$sql2="UPDATE `hospital` SET `h_email`='$email',`h_name`='$name',
`h_password`='$pass',`h_nic`='$nic',`h_contect`='$cont' WHERE h_id=$id ";


    // $sql2="UPDATE `patient` SET `p_email`='$email',`p_name`='$name',`p_password`='$pass',
    // `p_address`='$addres',`P_nic`=' $nic',`p_dob`='$dob',`p_contect`='$cont' WHERE p_id=$id";


    // $sql2= " UPDATE `patient` SET `pname`='$name',`pemail`='$email',
    // `ppassword`='$pass',`paddress`='$addres',`pdob`='$dob',`pgender`='$gender',`pnic`='$nic',`pcontect`='$cont' WHERE pid=$id";

    

// $sql2="UPDATE `user` set `names`='$name', `email`='$email', `passwords`='$pass' where id=$id";
// $sql2=" UPDATE `user` SET `n_name`='$name', `n_email`='$email', `n_password`='$pass', `n_contact`='$con' WHERE n_id=$id";
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name="name" value="<?php echo $row['h_name']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Email</label>
                                        <input class="form-control" type="email" name="email" value="<?php echo $row['h_email']; ?>">
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Password<span class="text-danger">*</span></label>
                                        <input class="form-control" type="password" name="pass" value="<?php echo $row['h_password']; ?>">
                                    </div>
                                </div>
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Address<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name="addres" value="<?php echo $row['p_address']; ?>">
                                    </div>
                                </div> -->
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>NIC</label>
                                        <input class="form-control" type="text" name="nic" value="<?php echo $row['h_nic']; ?>">
                                    </div>
                                </div>
                                 <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Contect</label>
                                            ...
                                            <input type="tel" name="cont" value="<?php echo $row['h_contect']; ?>" class="form-control">
                                ...
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Contect</label>
                                     <div class="">
                                        <input class="form-control" type="text" name="text" value="<?php echo $row['h_contect']; ?> ">
                                     </div>
                                    </div>
                                </div> -->
									...
									<div class="form-group gender-select">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" value="<?php echo $row['pgender']; ?>" class="form-check-input" checked>Male
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" value="<?php echo $row['pgender']; ?>" class="form-check-input">Female
											</label>
										</div>
									</div>
                                </div> -->
