...
$sql="INSERT INTO `schedule`(`sch_id`,`title`,`h_id`,`sch_date`, `sch_time`, `No_p`) VALUES (NULL,'$tile','$hname','$date','$time','$nop')";
...
?>
        ...
        <div class="page-wrapper">
            <div class="content">
                <div class="row">
                             <div class="col-md-12 mt-4 mb-5" style="display: flex;     justify-content: center;">
                    <h2>Add Session</h2>
                </div>
                </div>
                <div class="row">
                    <div class="col-lg-12">
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                    <label for="cars">Choose Hospital:</label>
                        <select class="form-control" name="name" id="employee">
                           ...
                           <?php } ?>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="number" name="nop">
                                    </div>
                                </div>
                                <div class="col-sm-6">
									...
									<div class="form-group gender-select">
										...
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" value="<" class="form-check-input" checked>Male
											</label>
										</div>
										<div class="form-check-inline">
											<label class="form-check-label">
												<input type="radio" name="gender" value="" class="form-check-input">Female
											</label>
										</div>
									</div>
                                </div> -->
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" name="submit"  class="btn btn-primary submit-btn" id="u1">Create Session</button>
                            </div>
                        </form>
                    </div>
                </div>
