                        ...
                        <form action="" method="post">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>NIC</label>
                                        <input class="form-control" type="text" name="nic" value="">
                                    </div>
                                </div>
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Contect</label>
                                            ...
                                            <input type="tel" name="cont" value="" class="form-control">
                            ...
                            <div class="m-t-20 text-center">
                                <button type="submit" name="submit"  class="btn btn-primary submit-btn">Create Hospital</button>
                            </div>
                        </form>
                    </div>
                </div>
