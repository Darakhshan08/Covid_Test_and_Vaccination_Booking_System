...
if($_POST){
    ...
    if ($cpassword){
        ...
        if($result->num_rows==1){
            ...
            $con->query("INSERT hospital(h_email,h_name,h_password,h_nic,h_contect) values('$email','$name','$newpassword','$nic','$tele');");
            $con->query("INSERT into web_user values('$email','h')");
...
<div class="main-wrapper  account-wrapper">
    ...
    <option value="Ziarat">Ziarat</option>
                    ...
                    <div class="form-group text-center">
                            <a href="signuphos.php"><button class="btn btn-primary account-btn" type="submit"> Patient Signup</button></a>
                        </div>
                </div>
            </div>
        </div>
