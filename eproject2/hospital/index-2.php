                ...
                <div class="ch" id="h3">
                    ...
                    <tr>
                        <td >
                            ...
                            <a href="appointments.php" class="non-style-link"><button class="btn-primary btn" style="width:30%">View My Appointments</button></a>
                            <br>
                            <br>
                        </td>
                    </tr>
                                ...
                                <div class="card-body p-0">
                                    <div class="table-responsive">
                                        <table class="table mb-0">
                                            ...
                                            <tbody> <th style="width:300px; margin-left:100px;">Appointment Number</th>
                                            <th>Patient Name</th>

                                            <th style="margin-left:100px;">Session</th>
...
&nbsp;
                    ...
                    <div class="row" id="t1" >
                        <div class="col-12 col-md-6 col-lg-8 col-xl-12">
                            <div class="card">
                                <div class="card-header">
                                    <h4 class="card-title d-inline-block">Your Upcoming Sessions until Next 
                                    <?php  
                                        echo date("l",strtotime("+1 week"));
                                        ?>
