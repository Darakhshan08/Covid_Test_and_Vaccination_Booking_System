...
?>
<!-- select * from schedule inner join appointment on schedule.sch_id=appointment.sch_id inner join patient on patient.p_id=appointment.p_id inner join hospital on schedule.h_id=hospital.h_id where patient.p_id and schedule.sch_date order by schedule.sch_date asc; -->
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="content">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4 col-3">
                        ...
                        $list110 = $con->query("select schedule.sch_id,schedule.title,hospital.h_name,schedule.sch_date,schedule.sch_time,schedule.No_p from schedule inner join hospital on schedule.h_id=hospital.h_id where hospital.h_id=$userid;");
...
<div class="row">
					<div class="col-md-12">
                        ...
                        <?php
                        $sqlmain="select schedule.sch_id,schedule.title,hospital.h_name,schedule.sch_date,schedule.sch_time,schedule.No_p from schedule inner join hospital on schedule.h_id=hospital.h_id where hospital.h_id=$userid";
